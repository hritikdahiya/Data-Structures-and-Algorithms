...
class ReconstructLongestCommonSubsequenceTest {

    @Test
    public void reconstructLongestCommonSubsequence() {
        ReconstructLongestCommonSubsequence lcs = new ReconstructLongestCommonSubsequence();

        String s1 = "HAHAH";
        String s2 = "AAAAHH";
        String expectedLcs = "AAH";
        Assertions.assertEquals(expectedLcs, lcs.lcsMemoization(s1, s2));
